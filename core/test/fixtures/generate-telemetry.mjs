...
session('s01-token-heavy', {
    ...
    editsAccepted: 18, editsRejected: 2, activeSeconds: 1320, commits: 3,
});
...
session('s03-mid-b', {
    ...
    editsAccepted: 7, editsRejected: 3, activeSeconds: 720, commits: 1,
});
...
session('s05-april-earliest', {
    ...
    editsAccepted: 9, editsRejected: 2, activeSeconds: 2400, commits: 2,
});

session('s06-may', {
    from: '2026-05-12T09:50:00Z', to: '2026-05-12T11:00:00Z',
    tokens: T(29000, 5000, 150000, 9000), linesAdded: 120, linesRemoved: 60,
    editsAccepted: 6, editsRejected: 1, activeSeconds: 3600, commits: 2,
});
...
session('s09-other-repo', {
    ...
    editsAccepted: 40, editsRejected: 5, activeSeconds: 3600, commits: 6,
});
...
session('s11-july-c', {
    ...
    editsAccepted: 4, editsRejected: 0, activeSeconds: 1500, commits: 1,
});
...
session('s14-july-d', {
    ...
    editsAccepted: 9, editsRejected: 1, activeSeconds: 900, commits: 2,
});

session('s15-june-b', {
    from: '2026-06-29T20:58:00Z', to: '2026-06-29T21:06:00Z',
    tokens: T(22000, 4000, 110000, 7000), linesAdded: 80, linesRemoved: 20,
    editsAccepted: 5, editsRejected: 2, activeSeconds: 480, commits: 2,
});
