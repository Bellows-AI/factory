...
export function AiUsagePanel({ telemetry, meta }: { telemetry: TelemetryStats; meta: TelemetryMeta }) {
    ...
    return (
        <section className="cards">
            ...
            <Card
                ...
                note={t.linesAdded === null ? 'lines written not recorded' : `${num(t.linesAdded, 0)} lines written`}
            />
        </section>
    );
}
