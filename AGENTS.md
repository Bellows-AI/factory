...
# --cluster installs the chart into a local minikube or kind cluster with a stub echo executor and
# watches a queued job come back succeeded through real pods. Needs helm; --cluster additionally
# needs minikube or kind.
npm run test:k8s
