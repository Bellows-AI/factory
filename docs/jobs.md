...
visible in `attempts`. The daemon's refusals reach the loop as docker CLI exit 125 — a container
that never existed — and take the same road rather than being reported as a verdict.
