...
- [x] 1.1 Write `server/migrations/027_workflows.sql`: a `workflow` table (org_id, id, name, scope
...
- [x] 1.2 Add `server/src/db/workflow-store.ts`: create/list/get/delete with the strict definition
